                    ...
                    <div class="navbar-nav mx-auto py-0">
                        ...
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Profile</a>
                            <div class="dropdown-menu m-0">
                                ...
                                <a href="/tugasfungsi" class="dropdown-item">Tugas dan Fungsi</a>
                                <a href="/struktur" class="dropdown-item">Struktur Organisasi</a>
                            </div>
                        </div>
                        <a href="/about" class="nav-item nav-link">About</a>
                        <a href="/" class="nav-item nav-link">Service</a>
                        <a href="frontend/project.html" class="nav-item nav-link">Project</a>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
                            <div class="dropdown-menu m-0">
                                <a href="#team" class="dropdown-item">Our Team</a>
                                <a href="frontend/testimonial.html" class="dropdown-item">Testimonial</a>
                                <a href="frontend/404.html" class="dropdown-item">404 Page</a>
                            </div>
                        </div>
                        <a href="frontend/contact.html" class="nav-item nav-link">Contact</a>
                    </div>
            ...
            <div class="container py-5 px-lg-5">
                <div class="row g-5">
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <div class="row g-2">
                            <div class="col-4">
                                <img class="img-fluid" src="frontend/img/portfolio-1.jpg" alt="Image">
                            </div>
                            <div class="col-4">
                                <img class="img-fluid" src="frontend/img/portfolio-2.jpg" alt="Image">
                            </div>
                            <div class="col-4">
                                <img class="img-fluid" src="frontend/img/portfolio-3.jpg" alt="Image">
                            </div>
                            <div class="col-4">
                                <img class="img-fluid" src="frontend/img/portfolio-4.jpg" alt="Image">
                            </div>
                            <div class="col-4">
                                <img class="img-fluid" src="frontend/img/portfolio-5.jpg" alt="Image">
                            </div>
                            <div class="col-4">
                                <img class="img-fluid" src="frontend/img/portfolio-6.jpg" alt="Image">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
